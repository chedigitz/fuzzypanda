...
Admin.mailer :gig do
  ...
  email :callsheet_email do |account, callsheet, venue, subject_line, location|
    # Your mailer goes here
    from 'gigs@pandafeed.tv'
    to account.email
    subject subject_line
    locals :venue => venue, :callsheet => callsheet, :location => location
    content_type 'text/html'
    render 'gig/callsheet_email'
  end
